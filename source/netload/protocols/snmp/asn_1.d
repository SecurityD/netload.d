...
//TODO: Conversion function have to moved as constructor so ASN1 will be usable with std.conv
struct ASN1 {
  enum Type : ubyte {
    INTEGER = 0x02,
    OCTET_STRING = 0x04,
...
unittest {
  JSONValue json = [
    "type": JSONValue(0x30),
    "data": [
      0x81, 0x85, 0x02, 0x01, 0x00, 0x04, 0x06, 0x00,
      0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0xa3, 0x78,
      0x02, 0x01, 0x3a, 0x02, 0x01, 0x00, 0x02, 0x01,
      0x00, 0x30, 0x6d, 0x30, 0x13, 0x06, 0x0e, 0x2b,
      0x06, 0x01, 0x04, 0x01, 0x81, 0x7d, 0x08, 0x33,
  ...
  ASN1 seq = json.toASN1;
  assert(seq.type == ASN1.Type.SEQUENCE);
  assert(seq.length == 136);
  assert(seq.data == [
    0x81, 0x85, 0x02, 0x01, 0x00, 0x04, 0x06, 0x00,
    0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0xa3, 0x78,
    0x02, 0x01, 0x3a, 0x02, 0x01, 0x00, 0x02, 0x01,
...
unittest {
  ...
  asn.type = ASN1.Type.OCTET_STRING;
  asn.data = [ 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63 ];
  JSONValue json = asn.toJSONValue;
  assert(json["type"] == ASN1.Type.OCTET_STRING);
...
unittest {
  ...
  JSONValue json = asn.toJSONValue;
  assert(json["type"] == ASN1.Type.SEQUENCE);
  assert(json["data"].toArrayOf!ubyte == [
    0x02, 0x01, 0x00, 0x04, 0x06, 0x70, 0x75, 0x62,
    0x6c, 0x69, 0x63, 0xa3, 0x78, 0x02, 0x01, 0x3a,
    0x02, 0x01, 0x00, 0x02, 0x01, 0x00, 0x30, 0x6d,
    0x30, 0x13, 0x06, 0x0e, 0x2b, 0x06, 0x01, 0x04,
